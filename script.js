  ...
  try {
    ...
    setTimeout(() => {
      ...
      newsGrid.innerHTML = `<div style="grid-column:1/-1;text-align:center;padding:40px;">
        ...
        <p style="margin-bottom:20px;">There was an error loading the latest technology news. Please try again later or check your API key.</p>
      </div>`;
    }, 1000);
  }
}
